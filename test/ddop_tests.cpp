...
TEST(DDOP_TESTS, DeviceTests)
{
	...
	auto tempPD = testDDOPVersion3.get_object_by_id(0).lock();
	...
	tempPD = testDDOPVersion4.get_object_by_id(0).lock();
	ASSERT_NE(nullptr, tempPD);
...
TEST(DDOP_TESTS, DeviceElementDesignatorTests)
{
	...
	auto tempPD = testDDOPVersion3.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::MainDeviceElement)).lock();
	ASSERT_NE(nullptr, tempPD);
	// Version 3 designator should be truncated
	EXPECT_EQ(32, tempPD->get_designator().size());

	tempPD = testDDOPVersion4.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::MainDeviceElement)).lock();
	ASSERT_NE(nullptr, tempPD);

	// Version 4 designator should be allowed
	EXPECT_EQ(76, tempPD->get_designator().size());

	tempPD = testDDOPVersion4_2.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::MainDeviceElement)).lock();
	ASSERT_NE(nullptr, tempPD);
...
TEST(DDOP_TESTS, ProcessDataTests)
{
	...
	auto tempPD = testDDOPVersion3.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::DeviceActualWorkState)).lock();
	ASSERT_NE(nullptr, tempPD);
	EXPECT_EQ(32, tempPD->get_designator().size());
	...
	tempPD = testDDOPVersion4.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::DeviceActualWorkState)).lock();
	ASSERT_NE(nullptr, tempPD);
	EXPECT_EQ(128, tempPD->get_designator().size());
...
TEST(DDOP_TESTS, PropertyTests)
{
	...
	auto tempProperty = testDDOPVersion3.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::ConnectorType)).lock();
	...
	tempProperty = testDDOPVersion4.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::ConnectorType)).lock();
	ASSERT_NE(nullptr, tempProperty);
	...
	tempProperty = testDDOPVersion4_2.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::ConnectorType)).lock();
	ASSERT_NE(nullptr, tempProperty);
...
TEST(DDOP_TESTS, PresentationTests)
{
	...
	auto tempPresentation = testDDOPVersion3.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::ShortWidthPresentation)).lock();
	...
	tempPresentation = testDDOPVersion3.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::LongWidthPresentation)).lock();
	ASSERT_NE(nullptr, tempPresentation);
	EXPECT_EQ(tempPresentation->get_designator().size(), 32);

	tempPresentation = testDDOPVersion4.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::ShortWidthPresentation)).lock();
	ASSERT_NE(nullptr, tempPresentation);
	EXPECT_EQ(tempPresentation->get_designator().size(), 128);

	tempPresentation = testDDOPVersion4.get_object_by_id(static_cast<std::uint16_t>(SprayerDDOPObjectIDs::LongWidthPresentation)).lock();
	ASSERT_NE(nullptr, tempPresentation);
