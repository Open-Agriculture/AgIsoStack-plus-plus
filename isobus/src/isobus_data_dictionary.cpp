...
/// Only the date above and the lookup table (DDI_ENTRIES) are auto-generated by
/// scripts/code_gen_ddi_database.py, the rest of this file is hand-written.
///
...
namespace isobus
{
	...
	std::string DataDictionary::Entry::format_value(const std::int32_t value) const
	{
		...
		switch (ddi)
		{
			...
			case static_cast<std::uint16_t>(DataDescriptionIndex::TrackControlState):
			{
				switch (value & 0x03)
				{
					case 0x00:
					...
					case 0x02:
						return "Error";
					case 0x03:
						return (static_cast<std::uint16_t>(DataDescriptionIndex::TrackControlState) == ddi) ? "Not supported" : "Not installed";
					default:
						return "Unknown";
				}
			}
			...
			case static_cast<std::uint16_t>(DataDescriptionIndex::SupportedTrackControlLevels):
			{
				if ((value < 0) || (value > 7))
				{
					return "Reserved";
			...
			case static_cast<std::uint16_t>(DataDescriptionIndex::SetpointTrackControlLevel):
			{
				switch (value)
				{
					case 0x00:
			...
			case static_cast<std::uint16_t>(DataDescriptionIndex::SetpointDropletSize):
			{
				switch (value)
				{
					...
					case 0x08:
						return "Ultra coarse";
					case 0xFF:
						return "No droplet size available";
					default:
						return "Reserved";
				}
			}
	...
	const DataDictionary::Entry DataDictionary::DDI_ENTRIES[] = {
		...
		{ 731, "Component Description", "", "n.a.", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 732, "Average Transmission Shaft Torque", "N*m", "Newton metre", 0.0001f, std::make_pair(-214748.3648f, 214748.3647f) },
		{ 733, "Maximum Transmission Shaft Torque", "N*m", "Newton metre", 0.0001f, std::make_pair(-214748.3648f, 214748.3647f) },
		{ 734, "Actual Transmission Shaft Joint Working Angle", "°", "Angle", 0.001f, std::make_pair(-180.0f, 180.0f) },
		{ 735, "Average Revolutions Per Time", "r/min", "Revolutions per minute", 0.0001f, std::make_pair(-214748.3648f, 214748.3647f) },
		{ 736, "Actual Vibrations X", "m/s²", "Acceleration", 0.001f, std::make_pair(-2147483.648f, 2147483.647f) },
		{ 737, "Actual Vibrations Y", "m/s²", "Acceleration", 0.001f, std::make_pair(-2147483.648f, 2147483.647f) },
		{ 738, "Actual Vibrations Z", "%", "Percent", 0.001f, std::make_pair(-2147483.648f, 2147483.647f) },
		{ 739, "Average Mechanical Power", "W", "Mechanical Power", 0.1f, std::make_pair(-214748364.8f, 214748364.7f) },
		{ 740, "Maximum Mechanical Power", "W", "Mechanical Power", 0.1f, std::make_pair(-214748364.8f, 214748364.7f) },
