...
/// This file was generated September 04, 2026.
///
...
namespace isobus
{
	...
	std::string DataDictionary::Entry::format_value(const std::int32_t value) const
	{
		...
		switch (ddi)
		{
			...
			case static_cast<std::uint16_t>(DataDescriptionIndex::TramlineControlLevel):
			{
				...
				// Bitmask, unlike 506: bits 0-2 are levels 1-3. Non-conformant combinations are shown as received.
	...
	const DataDictionary::Entry DataDictionary::DDI_ENTRIES[] = {
		...
		{ 406, "Actual Crude Protein Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 407, "Average Crude Protein Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		...
		{ 505, "Supported Track Control Levels", "", "n.a.", 1.0f, std::make_pair(0.0f, 7.0f) },
		{ 506, "Setpoint Track Control Level", "", "n.a.", 1.0f, std::make_pair(0.0f, 3.0f) },
		{ 507, "Guidance Track Sequence Number", "", "n.a.", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 508, "Unique Guidance Reference Line ID", "", "n.a.", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 509, "Actual Guidance Track Number", "", "n.a.", 1.0f, std::make_pair(-2147483648.0f, 2147483647.0f) },
		{ 510, "Guidance Track Number to the right", "", "n.a.", 1.0f, std::make_pair(-2147483648.0f, 2147483647.0f) },
		{ 511, "Guidance Track Number to the left", "", "n.a.", 1.0f, std::make_pair(-2147483648.0f, 2147483647.0f) },
		...
		{ 515, "Track Control State", "", "n.a.", 1.0f, std::make_pair(0.0f, 3.0f) },
		...
		{ 669, "Track Number Shift", "", "n.a.", 1.0f, std::make_pair(-2147483648.0f, 2147483647.0f) },
		{ 670, "Primary Working Width", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 671, "Primary Tire Width", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 672, "Primary Wheel Distance", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 673, "Secondary Working Width", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 674, "Secondary Tire Width", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 675, "Secondary Wheel Distance", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		...
		{ 695, "Mesh Total Used", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 696, "Film Total Used", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 697, "Twine Total Used", "mm", "Length", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 698, "Average Mass Per Bale", "kg", "Mass", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 699, "Average Mass Per Load", "kg", "Mass", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 700, "Nutrient Analysis Method", "", "n.a.", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 701, "Actual Starch Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 702, "Average Starch Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 703, "Actual Ash Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 704, "Average Ash Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 705, "Actual Sugar Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 706, "Average Sugar Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 707, "Actual Lipids Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 708, "Average Lipids Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 709, "Actual Crude Fat Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 710, "Average Crude Fat Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 711, "Actual Crude Fiber Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 712, "Average Crude Fiber Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 713, "Actual Nitrogen (TKN) Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 714, "Average Nitrogen (TKN) Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 715, "Actual Phosphates Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 716, "Average Phosphates Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 717, "Actual Potassium Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 718, "Average Potassium Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 719, "Actual ADL Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 720, "Average ADL Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 721, "Actual ADF Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 722, "Average ADF Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 723, "Actual NDF Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 724, "Average NDF Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 725, "Actual uNDFom240 Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 726, "Average uNDFom240 Content", "ppm", "Parts per million", 1.0f, std::make_pair(0.0f, 2147483647.0f) },
		{ 727, "Actual Biomethanation Production Potential", "mm³/kg", "Capacity per mass unit", 1.0E-6f, std::make_pair(0.0f, 2147.483647f) },
		{ 728, "Average Biomethanation Production Potential", "mm³/kg", "Capacity per mass unit", 1.0E-6f, std::make_pair(0.0f, 2147.483647f) },
		{ 729, "Average Corn Silage Processing Score", "%", "Percent", 0.001f, std::make_pair(0.0f, 100.0f) },
		{ 730, "Actual Tare Weight", "g", "Mass large", 1.0f, std::make_pair(-2147483648.0f, 2147483647.0f) },
		...
		{ 32774, "Maximum Corn Silage Processing Score", "%", "Percent", 0.001f, std::make_pair(0.0f, 100.0f) },
		...
		{ 36870, "Minimum Corn Silage Processing Score", "%", "Percent", 0.001f, std::make_pair(0.0f, 100.0f) },
		...
		{ 45062, "Actual Corn Silage Processing Score", "%", "Percent", 0.001f, std::make_pair(0.0f, 100.0f) },
		...
		{ 49158, "Setpoint Corn Silage Processing Score", "%", "Percent", 0.001f, std::make_pair(0.0f, 100.0f) },
