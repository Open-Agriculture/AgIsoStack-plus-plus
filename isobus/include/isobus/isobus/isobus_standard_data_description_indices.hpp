...
namespace isobus
{
	...
	{
		InternalDataBaseDDI = 0x0000, ///< This DDI is reserved for internal use only.
		...
		NumberOfSubUnitsPerSection = 0x009F, ///< Specifies the number of Units for a section (e.g. number of nozzles per sprayer section or number of planter seeding rows common to a controlled section).
		...
		SCSetpointTurnOnTime = 0x00CD, ///< The Section Control Turn On Time defines the overall time lapse between the moment the TC sends a turn on section command to the working set and the moment this section is physically turned on and the product is applied.
		SCSetpointTurnOffTime = 0x00CE, ///< The Section Control Turn Off Time defines the overall time lapse between the moment the TC sends a turn off section command to the working set and the moment this section is physically turned off.
		...
		RelativeHumidity = 0x00D1, ///< Ambient humidty measured by a weather station in a treated field or on the application implement.
		...
		SetpointBaleCompressionPlungerLoad = 0x00DA, ///< The setpoint bale compression plunger load expressed as percentage.
		ActualBaleCompressionPlungerLoad = 0x00DB, ///< The actual bale compression plunger load expressed as percentage.
		...
		LastBaleTagNumber = 0x00DE, ///< The Last Bale Tag Number as a decimal number in the range of 0 to 2147483647. Note that the value of this DDI has the limitation of being a signed 32 bit number.
		...
		LoadIdentificationNumber = 0x0142, ///< The Load Identification Number as a decimal number in the range of 0 to 2147483647. Note that the value of this DDI has the limitation of being a signed 32 bit number.
		...
		TotalLoadingTime = 0x0153, ///< The total time needed in the current task to load a product such as crop.
		TotalUnloadingTime = 0x0154, ///< The total time needed in the current task to unload a product crop.
		...
		TotalApplicationOfPotassium = 0x0164, ///< Accumulated application of potassium [K] specified as gram [g]
		...
		ActualApplicationOfPotassium = 0x0194, ///< Actual application of Potassium [K] specified as gram [g]
		ActualApplicationOfDryMatter = 0x0195, ///< Actual dry matter content of the applied liquid as mass per volume. Dry matter measured at Zero percent of moisture.
		ActualCrudeProteinContent = 0x0196, ///< Actual Crude Protein content of a harvested crop, expressed as a percentage based on dry substance.
		AverageCrudeProteinContent = 0x0197, ///< Average Crude Protein content of a harvested crop, expressed as a percentage based on dry substance.
		...
		SupportedTrackControlLevels = 0x01F9, ///< This DDI defines the Track Control capability of the Implement.
		SetpointTrackControlLevel = 0x01FA, ///< This DDI defines the track control level of the Task Controller that is used with the appropriate Implement.
		GuidanceTrackSequenceNumber = 0x01FB, ///< This DDI specifies the sequence number of the current guidance track sequence.
		UniqueGuidanceReferenceLineID = 0x01FC, ///< This DDI is a unique ID and specifies which guidance reference line is the base for the tramline calculation.
		ActualGuidanceTrackNumber = 0x01FD, ///< This DDI specifies the guidance track number the implement is currently located on.
		GuidanceTrackNumberToTheRight = 0x01FE, ///< This DDI specifies the guidance track number to right hand side in direction of implement orientation.
		GuidanceTrackNumberToTheLeft = 0x01FF, ///< This DDI specifies the guidance track number to left hand side in direction of implement orientation.
		GuidanceLineSwathWidth = 0x0200, ///< The Swath Width is the Distance between two adjacent Guidance Lines in a Guidance Pattern.
		GuidanceLineDeviation = 0x0201, ///< This DDI specifies the deviation in mm from this guidance line and the device reference point (DRP) which is guided along the guidance line when looking from the implement to the actual guidance track number.
		GNSSQuality = 0x0202, ///< This DDI specifies the quality of the GNSS used by the guidance system in the same manner as the NMEA2000 Method GNSS parameter.
		TrackControlState = 0x0203, ///< Specifies the actual state of Track Control. See isobus.net
		TramlineOverdosingRate = 0x0204, ///< This DDI specifies the tramline overdosing rate for the rows adjacent to the tramline tire path.
		...
		MeshBaleTotalCount = 0x020B, ///< The total number of mesh bound product units for which mesh binding method was used during operation.
		...
		LifetimeMeshBaleTotalCount = 0x020D, ///< Total number of mesh bound product units for which mesh binding method was used during operation, of a device lifetime
		...
		PreviousRainfall = 0x024B, ///< DDI to document the previous rainfall.
		...
		ActualCO2EquivalentSpecifiedAsMassPerCount = 0x0297, ///< Actual CO2 equivalent specified as mass per count.
		...
		MinimumDropletSize = 0x9000, ///< The minimum droplet size the system can produce.
