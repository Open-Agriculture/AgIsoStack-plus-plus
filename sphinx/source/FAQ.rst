...
.. code-block:: text
   ...
   /usr/bin/ld: ISO11783-CAN-Stack/socket_can/libSocketCANInterface.so: undefined reference to `pthread_create'
...
https://github.com/ad3154/ISO11783-CAN-Stack/issues
